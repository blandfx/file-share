...
def download():
    ...
    return render_template('download.html', downloads=active_downloads)
...
def list_files():
    ...
    files_with_details = [
        {
            'name': f,
            'edit_url': url_for('submit_text', filename=f) if f.endswith('.txt') else None,
...
TORRAN_CONFIG = {
    ...
    'JACKETT_API_KEY': 'npm4hyr7c2ur7pi7zeoxoye8fldtax2x',
